...
import com.example.instasaver.Models.Reel.EdgeLikedBy;
import com.example.instasaver.Models.Reel.EdgeThreadedComments;
import com.example.instasaver.Models.Reel.Owner;
...
public class Node__1 {
    ...
    @Expose
    private com.example.instasaver.Models.Reel.EdgeLikedBy edgeLikedBy;
    @SerializedName("is_restricted_pending")
    @Expose
    private Boolean isRestrictedPending;
    @SerializedName("edge_threaded_comments")
    @Expose
    private com.example.instasaver.Models.Reel.EdgeThreadedComments edgeThreadedComments;
    ...
    public com.example.instasaver.Models.Reel.EdgeLikedBy getEdgeLikedBy() {
        return edgeLikedBy;
    }
    ...
    public com.example.instasaver.Models.Reel.EdgeThreadedComments getEdgeThreadedComments() {
